...
class menu:
    def __init__(self):
        ...
        l1=Button(self.a,text='BOOK',font='Papyrus 22 bold',fg='maroon1',bg='WHITE',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)
        l2=Button(self.a,text='STUDENTS',font='Papyrus 22 bold',fg='maroon1',bg='WHITE',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Books',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.search).place(x=12,y=200)
        l4=Button(self.a,text='Show List Book',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    def addbook(self):
        self.aid=StringVar()
        ...
        l1=Label(self.f1,text='Book ID : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.aid).place(x=150,y=50)
        l2=Label(self.f1,text='Title : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=100)
        e2=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.aname).place(x=150,y=100)
        l3=Label(self.f1,text='Author : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.aauthor).place(x=150,y=150)
        l4=Label(self.f1,text='Genre : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=200)
        e2=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.agenre).place(x=150,y=200)
        l4=Label(self.f1,text='Copies : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=250)
        e2=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.acopies).place(x=150,y=250)
        l5=Label(self.f1,text='Location : ',font='Papyrus 12 bold',fg='HotPink1',bg='WHITE',pady=1).place(x=50,y=300)
        e3=Entry(self.f1,width=45,bg='HotPink1',fg='WHITE',textvariable=self.aloc).place(x=150,y=300)
        self.f1.grid_propagate(0)
        b1=Button(self.f1,text='Add',font='Papyrus 10 bold',fg='WHITE',bg='HotPink1',width=15,bd=3,command=self.adddata).place(x=150,y=400)
        b2=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='WHITE',bg='HotPink1',width=15,bd=3,command=self.rm).place(x=350,y=400)
    def rm(self):
        self.f1.destroy()
    def mainmenu(self):
        self.root.destroy()
    ...
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='WHITE')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('Papyrus 10 bold'),bd=2, fg='HotPink1',bg='WHITE').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='HotPink1',fg='WHITE',textvariable=self.sid).place(x=260,y=40)
        b1=Button(self.f1,text='Search',bg='HotPink1',font='Papyrus 10 bold',width=9,bd=2,command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',bg='HotPink1',font='Papyrus 10 bold',width=10,bd=2,command=self.rm).place(x=250,y=450)
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',font='Papyrus 10 bold',bg='HotPink1',fg='WHITE',width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',font='Papyrus 10 bold',bg='HotPink1',fg='WHITE',width=9,bd=3,command=self.copiesdelete).place(x=500,y=97)
        except:
            messagebox.showinfo("Empty","Please select something.")
    def copiesadd(self):
        no=self.e5.get()
    ...
    def all(self):
        self.f1=Frame(self.a,height=500,width=650,bg='WHITE')
        self.f1.place(x=500,y=100)
        b1=Button(self.f1,text='Back',bg='HotPink1' ,fg='WHITE',width=10,bd=3,command=self.rm).place(x=250,y=400)
        conn=sqlite3.connect('test.db')
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.issue).place(x=12,y=100)
        l2=Button(self.a,text='Return Book',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.returnn).place(x=12,y=200)
        l3=Button(self.a,text='Show List Students',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Papyrus 22 bold',fg='HotPink1',bg='WHITE',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
    def issue(self):
        self.aidd=StringVar()
        self.astudentt=StringVar()
        self.f1=Frame(self.a,height=550,width=500,bg='WHITE')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='papyrus 15 bold',bg='WHITE',fg='HotPink1').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='HotPink1',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',bg='WHITE',fg='HotPink1').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='HotPink1',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='WHITE',bg='HotPink1',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Issue',font='Papyrus 10 bold',fg='WHITE',bg='HotPink1',width=10,bd=3,command=self.issuedbook).place(x=200,y=250)
    def issuedbook(self):
    ...
    def returnn(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='WHITE')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='papyrus 15 bold',fg='HotPink1', bg='WHITE').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='HotPink1',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',fg='HotPink1', bg='WHITE').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='HotPink1',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Papyrus 10 bold',bg='HotPink1',fg='WHITE',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Return',font='Papyrus 10 bold',bg='HotPink1',fg='WHITE',width=10,bd=3,command=self.returnbook).place(x=200,y=250)
        self.f1.grid_propagate(0)
    def returnbook(self):
        a=self.aidd.get()
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='Papyrus 15 bold',fg='HotPink1',bg='WHITE').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='HotPink1',textvariable=self.aidd).place(x=280,y=35)
        b1=Button(self.f1,text='Back',bg='HotPink1',font='Papyrus 10 bold',width=10,bd=3,command=self.rm).place(x=340,y=450)
        b1=Button(self.f1,text='Search',bg='HotPink1',font='Papyrus 10 bold',width=10,bd=3,command=self.searchact).place(x=40,y=450)
        b1=Button(self.f1,text='All',bg='HotPink1',font='Papyrus 10 bold',width=10,bd=3,command=self.searchall).place(x=190,y=450)
        self.f1.grid_propagate(0)
    def searchact(self):
        self.list2=("BOOK ID","STUDENT ID","ISSUE DATE","RETURN DATE")
        self.trees=self.create_tree(self.f1,self.list2)
...
USERNAME = StringVar()
PASSWORD = StringVar()
lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('Papyrus', 30,'bold', ),bg='WHITE', fg='HotPink1')
lbl_title.place(x=500,y=100)
lbl_username = Label(canvas, text = "Username:", font=('Papyrus', 15,'bold'),bd=4,bg='WHITE', fg='HotPink1')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "Password :", font=('Papyrus', 15,'bold'),bd=3, bg='WHITE', fg='HotPink1')
lbl_password.place(x=500, y=330)
lbl_text = Label(canvas)
lbl_text.place(x=450,y=500)
lbl_text.grid_propagate(0)
username = Entry(canvas, textvariable=USERNAME, font=(14), bg='WHITE', fg='HotPink1',bd=6)
username.place(x=650, y=230,)
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(14),bg='WHITE', fg='HotPink1',bd=6)
password.place(x=650, y=330)
btn_login = Button(canvas, text="LOGIN", font=('Papyrus 15 bold'),width=25,command=Login, bg='WHITE', fg='HotPink1')
